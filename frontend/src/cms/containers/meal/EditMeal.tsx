...
import { getMeal, putMeal, deleteMeal } from "../../reducers/meal/actions";
...
class EditMeal extends Component<any, any> {
  ...
  constructor(props) {
    super(props);
    props.getMeal(props.match.params.username, props.match.params.mealUid);
  }

  handleSubmit(meal: IMeal) {
    this.props.putMeal(this.props.match.params.username, this.props.match.params.mealUid, meal);
  }

  handleDelete() {
    this.props.deleteMeal(this.props.match.params.username, this.props.match.params.mealUid);
